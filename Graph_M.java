...
import java.io.*;
	...
	public class Graph_M 
	{
		...
		{
			System.out.println("\t Tumkur Metro Map");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Kyathsandra S.S Matha~B");
			g.addVertex("SIT College ~B");
			g.addVertex("Tumkur University~B");
			g.addVertex("SS Puram~BY");
			g.addVertex("Siddaganga Hospital~B");
			g.addVertex("Akka Tangi Park~B");
			g.addVertex("Amani kere Garden~BO");
			g.addVertex("Tumkur High Court~B");
			g.addVertex("Tumkur Bus Stand~Y");
			g.addVertex("Tumkur Railway Station~Y");
			g.addVertex("M.G Road~Y");
			g.addVertex("Bar Lane~Y");
			g.addVertex("Mandi Pet~YO");
			g.addVertex("CALTEX~Y");
			g.addVertex("Gubbi Gate~O");
			g.addVertex("Bheemsandra~O");
			g.addVertex("Heggere~O");
			g.addVertex("Malsandra~BP");
			g.addVertex("Gubbi Bus Stand~PR");
			g.addVertex("CIT College~P");
			
			g.addEdge("Kyathsandra S.S Matha 62~B", "SIT College~B", 8);
			g.addEdge("SIT College~B", "Tumkur University~B", 10);
			g.addEdge("Tumkur University~B", "Siddaganga Hospital~B", 8);
			g.addEdge("Tumkur University~B", "SS Puram~BY", 6);
			g.addEdge("SS Puram~BY", "Akka Tangi Park~B", 9);
			g.addEdge("Akka Tangi Park~B", "Amani kere Garden~BO", 7);
			g.addEdge("Amani kere Garden~BO", "Tumkur High Court 21~B", 6);
			g.addEdge("Tumkur Bus Stand~Y", "Tumkur Railway Station~Y", 15);
			g.addEdge("Tumkur Railway Station~Y", "CALTEX~Y", 6);
			g.addEdge("CALTEX~Y", "SS Puram~BY", 7);
			g.addEdge("SS Puram~BY", "Mandi Pet~YO", 1);
			g.addEdge("Mandi Pet~YO", "Bar Lane~Y", 2);
			g.addEdge("Bar Lane~Y", "M.G Road~Y", 5);
			g.addEdge("Mandi Pet~YO", "Gubbi Gate~O", 2);
			g.addEdge("Gubbi Gate~O", "Bheemsandra~O", 7);
			g.addEdge("Bheemsandra~O", "Heggere~O", 8);
			g.addEdge("Akka Tangi Park~B", "Malsandra~BP", 2);
			g.addEdge("CIT College~P", "Malsandra~BP", 2);
			g.addEdge("CIT College~P", "Gubbi Bus Stand~PR", 3);
		}
